...
# Date    : 2020Jul09-1033-09CEST
# version : 0.0.0 
#
# template file is generated by e3TemplateGenerator.bash with 047d0b3
...
#########################################################################################
##
## Dependency information: Here you should add the required information for all modules
## that your module depends on.
##
#########################################################################################

##
## If one has dependencies that are not binary (i.e. CALC in .db files, or in .cmd/.iocsh files)
## then you should add the relevant modules here.
##

#REQUIRED += calc

##
## You must also include dependency information for all modules in $(REQUIRED) as well as
## those in CONFIG_MODULES.
##
...
#########################################################################################
##
## Architectures to exclude from compilation.
##
#########################################################################################
...
#########################################################################################
##
## Include directories that are passed to the compiler.
##
#########################################################################################
...
#########################################################################################
##
## You may want to add some compiler flags, a few possibilities are below.
##
#########################################################################################
...
#########################################################################################
##
## These files will all be installed in $(E3_SITEMODS_PATH)/$(PRJ)/$(MODULE_VERSION)/db/
##
#########################################################################################
...
#########################################################################################
##
## These files will all be compiled and moved to $(SITE_MODS)/$(PRJ)/$(MODULE_VERSION)/lib/$(T_A)
##
#########################################################################################
...
#########################################################################################
##
## These files will all be combined and installed in $(E3_SITEMODS_PATH)/$(PRJ)/$(MODULE_VERSION)/dbd/
##
#########################################################################################
...
#########################################################################################
##
## These are installed in the root module directory, $(E3_SITEMODS_PATH)/$(PRJ)/$(MODULE_VERSION)
##
#########################################################################################
